...
import re
import csv
import time  # Import time to implement delay
...
def get_company_info(docx_file):
    ...
    company_info = []
    search_count = 0  # Initialize counter for searches

    for company in company_names:
        print(f"Searching for {company}...")
        website = get_company_website(company)
        search_count += 1  # Increment search count after each search
        ...
        # Introduce a delay after every 5 searches
        if search_count % 5 == 0:
            print("Pausing for 2 minute to avoid being blocked...")
            time.sleep(120)  # 2-minute delay

    return company_info

# Run the process for the uploaded DOCX file
docx_file_path = r"C:\Users\azimu\Downloads\Maschinenbau.docx"  # Update with the actual path to your docx file
